Pod::Spec.new do |s|
	...
	s.homepage	  	= 'https://github.com/EwyynTomato/EWTBackgroundLocalNotification.git'
  ...
  s.screenshots   = [ 'https://raw.githubusercontent.com/EwyynTomato/EWTBackgroundLocalNotification/master/screenshots/preview.gif' ]
	s.source	    	= { :git => 'https://github.com/EwyynTomato/EWTBackgroundLocalNotification.git', :tag => s.version.to_s }
